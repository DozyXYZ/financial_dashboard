        ...
        <>
            ...
            <DashboardBox gridArea="e">
                ...
                <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
                    ...
                    <Box ml="-0.7rem" flexBasis="40%" textAlign="center">
                        ...
                        <Typography m="0.3rem 0" variant="h3" color={palette.primary[300]}>94</Typography>
                        <Typography variant="h6">We will fight to the bitter end!</Typography>
                        <Typography variant="h6">May the odds be ever in your favor!</Typography>
                    </Box>

                    <Box ml="-0.7rem" flexBasis="40%">
                        <Typography variant="h5">Revenue</Typography>
                        <Typography variant="h6">Increased 100%</Typography>
            ...
            <DashboardBox gridArea="f">
                <BoxHeader
                    ...
                    rightSideText="There is no pattern here!"
                />
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Scatter name="Product Expense Ratio" data={productExpense} fill={palette.tertiary[500]} />
                    </ScatterChart>
                </ResponsiveContainer>
            </DashboardBox>
        </>
